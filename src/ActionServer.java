...
public class ActionServer {
  public static void main(String[] args) throws IOException {
	...
	bank.put("User01", (double) 1000);
	bank.put("User02", (double) 1000);
	bank.put("User03", (double) 1000);
    SharedActionState ourSharedActionStateObject = new SharedActionState(bank);
